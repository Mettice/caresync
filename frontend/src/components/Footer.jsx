  ...
  return (
    <footer className="bg-gradient-to-r from-blue-50 to-indigo-50 border-t border-blue-100">
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="text-xl font-bold text-blue-600">CareSync AI</span>
            </div>
            <p className="text-gray-600 mb-4">
              Transforming the healthcare intake process with intelligent scheduling, reminders, and communication management.
            </p>
            <p className="text-gray-500 text-sm">
              © {currentYear} CareSync AI. All rights reserved.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/features" className="text-blue-600 hover:text-blue-800 transition-colors">
                  Features
                </Link>
              </li>
              <li>
                <Link to="/form" className="text-blue-600 hover:text-blue-800 transition-colors">
                  Intake Form
                </Link>
              </li>
              <li>
        ...
        {/* Social Links */}
        <div className="mt-8 pt-6 border-t border-blue-100 flex justify-center space-x-6">
